...
func pullRoleDetail(roleId int) (common.Role, error) {
	var r common.Role
...
func (buildTree *buildTree) getCasbinRole() error {
	roleDetail, err := common.GetRoleDetailByRoleId(buildTree.RoleId)
	if err != nil {
		return err
	}
...
func (buildTree *buildTree) getCodes() error {
	filteredPolicy, err := common.GetRoleCodes(buildTree.CasbinRole)
	if err != nil {
		return err
	}
